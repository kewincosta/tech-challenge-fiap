...
| --- | --- | --- | --- |
| SVC-01 | P1: An administrator maintains the service catalog | Tasks | Verified |
| SVC-02 | P1: Staff read the catalog to pick work | Tasks | Verified |
| SVC-03 | P1: A price is integer BRL cents, end to end | Tasks | Verified |
| SVC-04 | P2: A deactivated service leaves the catalog without disappearing | Tasks | Verified |
